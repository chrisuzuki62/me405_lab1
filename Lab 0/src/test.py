...
import math           # We don't really need it; this is just an example

## List of characters contains valuable information about the Universe
...
def the_answer (two):
    ...
    @param   two An integer given to this function which should be 2
...
if __name__ == "__main__":
    ...
    print ("The Answer (spoiler alert): {:d}".format (the_answer (2)))